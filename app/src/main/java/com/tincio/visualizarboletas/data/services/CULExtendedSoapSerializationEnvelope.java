...
public class CULExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    static HashMap< String,Class> classNames = new HashMap< String, Class>();
    static {
        classNames.put("http://entity.sibe.gmd.com.pe/xsd^^BAuditoria",CULBAuditoria.class);
        classNames.put("http://entity.sibe.gmd.com.pe/xsd^^Documento",CULDocumento.class);
        classNames.put("http://entity.sibe.gmd.com.pe/xsd^^DocumentoProceso",CULDocumentoProceso.class);
        classNames.put("http://entity.sibe.gmd.com.pe/xsd^^DocumentoDetalle",CULDocumentoDetalle.class);
        classNames.put("http://entity.sibe.gmd.com.pe/xsd^^Seccion",CULSeccion.class);
        classNames.put("http://entity.sibe.gmd.com.pe/xsd^^TipoDocumental",CULTipoDocumental.class);
        classNames.put("http://xsd.bean.wsdocuservici.gmd.com.pe/xsd^^UsuarioDatos",CULUsuarioDatos.class);
        classNames.put("http://wsdocuservutil.gmd.com.pe^^getListadoDocumentosNoRevisadosResponse",CULgetListadoDocumentosNoRevisadosResponse.class);
        classNames.put("http://wsdocuservutil.gmd.com.pe^^getListadoDocumentosResponse",CULgetListadoDocumentosResponse.class);
    }   

    protected static final int QNAME_NAMESPACE = 0;
    private static final String TYPE_LABEL = "type";

    public CULExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CULExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CULMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            ...
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=String.class  )) {
                String xmlName=CULHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public Object get(Object soap,Class cl)
    {
        ...
        try
        {
            ...
            {
                Constructor ctor = cl.getConstructor(Object.class,CULExtendedSoapSerializationEnvelope.class);
