...
public class WRHExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    static HashMap< String,Class> classNames = new HashMap< String, Class>();
    static {
        classNames.put("http://entity.sibe.gmd.com.pe/xsd^^BAuditoria",WRHBAuditoria.class);
        classNames.put("http://entity.sibe.gmd.com.pe/xsd^^Documento",WRHDocumento.class);
        classNames.put("http://entity.sibe.gmd.com.pe/xsd^^DocumentoProceso",WRHDocumentoProceso.class);
        classNames.put("http://entity.sibe.gmd.com.pe/xsd^^DocumentoDetalle",WRHDocumentoDetalle.class);
        classNames.put("http://entity.sibe.gmd.com.pe/xsd^^Seccion",WRHSeccion.class);
        classNames.put("http://entity.sibe.gmd.com.pe/xsd^^TipoDocumental",WRHTipoDocumental.class);
        classNames.put("http://xsd.bean.wsdocuservici.gmd.com.pe/xsd^^UsuarioDatos",WRHUsuarioDatos.class);
    ...
    public WRHExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public WRHExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new WRHMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            ...
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=String.class  )) {
                String xmlName=WRHHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public Object get(Object soap,Class cl,boolean typeFromClass)
    {
        ...
        try
        {
            ...
            {
                Constructor ctor = cl.getConstructor(Object.class,WRHExtendedSoapSerializationEnvelope.class);
