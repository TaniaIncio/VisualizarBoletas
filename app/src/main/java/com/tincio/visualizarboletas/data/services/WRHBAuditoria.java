...
public class WRHBAuditoria extends AttributeContainer implements KvmSerializable
{
    ...
    public WRHBAuditoria ()
    {
    }

    public WRHBAuditoria (Object paramObj,WRHExtendedSoapSerializationEnvelope __envelope)
    {
                ...
                if (info.name.equals("feUsuaCrea"))
                {
                    if(obj!=null)
                    {
                        ...
                        if (obj.getClass().equals(SoapPrimitive.class))
                        {
                            ...
                            if(j.toString()!=null)
                            {
                                this.feUsuaCrea = WRHHelper.ConvertFromWebService(j.toString());
                            }
                        }
                ...
                if (info.name.equals("feUsuaModi"))
                {
                    if(obj!=null)
                    {
                        ...
                        if (obj.getClass().equals(SoapPrimitive.class))
                        {
                            ...
                            if(j.toString()!=null)
                            {
                                this.feUsuaModi = WRHHelper.ConvertFromWebService(j.toString());
                            }
                        }
                        else if (obj instanceof java.util.Date){
    ...
    public Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==2)
        {
            return this.feUsuaCrea!=null?WRHHelper.getDateFormat().format(this.feUsuaCrea):SoapPrimitive.NullSkip;
        }
        if(propertyIndex==3)
        {
            return this.feUsuaModi!=null?WRHHelper.getDateFormat().format(this.feUsuaModi):SoapPrimitive.NullSkip;
        }
        if(propertyIndex==4)
        {
